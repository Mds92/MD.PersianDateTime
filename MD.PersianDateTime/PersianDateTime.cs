...
/// Contributed by Nima Nikoo Mail : nikoonazar.nima@gmail.com
/// 1393/09/14
/// </summary>
[Serializable]
    ...
    IEquatable<PersianDateTime>, IEquatable<DateTime>
{
    ...
    public int Year
    {
        get
        {
            ...
            return PersianCalendar?.GetYear(_dateTime) ?? 0;
        }
    }
    ...
    public int Month
    {
        get
        {
            ...
            return PersianCalendar?.GetMonth(_dateTime) ?? 0;
        }
    }
        ...
        get
        {
            if (PersianCalendar != null)
                return _dateTime <= DateTime.MinValue
                    ...
                    : PersianCalendar.GetDayOfMonth(_dateTime);
            return 0;
        }
    }
    ...
    public DayOfWeek DayOfWeek
    {
        get
        {
            if (PersianCalendar != null)
                return _dateTime <= DateTime.MinValue
                    ? DateTime.MinValue.DayOfWeek
                    : PersianCalendar.GetDayOfWeek(_dateTime);
    ...
    public PersianDayOfWeek PersianDayOfWeek
    {
        get
        {
            if (PersianCalendar == null) return PersianDayOfWeek.Saturday;
    ...
    public int Hour
    {
        ...
        {
            if (PersianCalendar != null)
                return _dateTime <= DateTime.MinValue ? 12 : PersianCalendar.GetHour(_dateTime);
            return 0;
        }
    }
    ...
    public int Minute
    {
        ...
        {
            if (PersianCalendar != null)
                return _dateTime <= DateTime.MinValue ? 0 : PersianCalendar.GetMinute(_dateTime);
            return 0;
        }
    }
    ...
    public int Second
    {
        get
        {
            ...
            return PersianCalendar?.GetSecond(_dateTime) ?? 0;
        }
    }
    ...
    public int Millisecond
    {
        ...
        {
            if (_dateTime <= DateTime.MinValue) return 0;
            if (PersianCalendar != null) return (int)PersianCalendar.GetMilliseconds(_dateTime);
            return 0;
        }
    }
    ...
    public int GetWeekOfYear
    {
        ...
        {
            if (_dateTime <= DateTime.MinValue) return 0;
            return PersianCalendar?.GetWeekOfYear(_dateTime, CalendarWeekRule.FirstDay, DayOfWeek.Saturday) ?? 0;
        }
    }
    ...
    public int GetDayOfYear
    {
        ...
        {
            if (_dateTime <= DateTime.MinValue) return 0;
            return PersianCalendar?.GetDayOfYear(_dateTime) ?? 0;
        }
    }
    ...
    public bool IsLeapYear
    {
        get
        {
            ...
            return PersianCalendar != null && PersianCalendar.IsLeapYear(Year);
        }
    }
    ...
    public string GetLongDayOfWeekName
    {
        get
        {
            string weekDayName = DayOfWeek switch
            {
    ...
    public string GetShortDayOfWeekName
    {
        get
        {
            var weekDayName = DayOfWeek switch
            {
                DayOfWeek.Sunday => "ی",
                DayOfWeek.Monday => "د",
                DayOfWeek.Tuesday => "س",
    ...
    public string TimeOfDay
    {
        get
        {
            ...
            return !PersianNumber ? result : ToPersianNumber(result);
        }
    }
    ...
    {
        if (PersianCalendar != null)
            _dateTime = PersianCalendar.ToDateTime(persianYear, persianMonth, persianDay, hour, minute, second,
                millisecond);
    }
